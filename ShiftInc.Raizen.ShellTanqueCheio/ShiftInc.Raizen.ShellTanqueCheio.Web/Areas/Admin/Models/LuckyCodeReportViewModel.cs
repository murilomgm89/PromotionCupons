...
namespace ShiftInc.Raizen.ShellTanqueCheio.Web.Areas.Admin.Models
{
    public class LuckyCodeReportViewModel
    {
        ...
        public List<Entity.LuckyCode> LuckyCodes { get; set; }

        public List<ShiftInc.Raizen.ShellTanqueCheio.Web.Areas.Admin.Models.DashboardViewModel.ChartItem> LuckyCodeChartData { get; set; }
